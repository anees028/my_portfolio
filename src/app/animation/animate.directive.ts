...
export class AnimateDirective extends AnimateService {
  ...
  protected override get viewRect(): DOMRect {
    ...
    return { top, left, bottom, right, height: bottom - top, width: right - left } as DOMRect;
  }

  constructor(private elref: ElementRef<HTMLElement>, override readonly viewPort: ViewportRuler, scroll: ScrollDispatcher, zone: NgZone) {
